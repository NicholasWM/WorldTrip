...
let continentFormatedData= {
  "Asia": {
      ...
      "info": "A Ásia é o maior dos continentes, tanto em área como em população. Abrange um terço das partes sólidas da superfície da Terra e é responsável por abrigar quase três quintos da população mundial.",
      "cities": [
          {
              "country": "China (SAR)",
              "name": "Hong Kong",
  ...
  "North America": {
      ...
      "info": "A América do Norte é um subcontinente que compreende a porção setentrional do continente americano.",
      "cities": [
          {
              "country": "USA",
              "name": "New York City",
  ...
  "Africa": {
      ...
      "info": "A África é o terceiro continente mais extenso com cerca de 30 milhões de quilômetros quadrados, cobrindo 20,3% da área total da terra firme do planeta. É o segundo continente mais populoso da Terra com cerca de um bilhão de pessoas, representando cerca de um sétimo da população mundial, e 54 países independentes. ",
      "cities": [
          {
              "country": "Egypt",
              "name": "Cairo",
  ...
  "Oceania": {
      ...
      "info": "Oceania ou Oceânia é uma região geográfica composta por vários grupos de ilhas do oceano Pacífico. O termo Oceania foi criado em 1831 pelo explorador francês Dumont d Urville. ",
      "cities": [
          {
              "country": "Australia",
              "name": "Sydney",
  ...
  "South America": {
      ...
      "info": "A América do Sul é um continente que compreende a porção meridional da América. Também é considerada um subcontinente do continente americano. A sua extensão é de 17 819 100 km², abrangendo 12% da superfície terrestre e 6% da população mundial.",
      "cities": [
          {
              "country": "Argentina",
              "name": "Buenos Aires City",
